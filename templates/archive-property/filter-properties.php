    ...
    <form class="property-filter-form" id="property-filters">
        ...
        <ul class="filter-navigation menu">
            ...
            <li class="menu-item-has-children filter price">
                <button class="btn-filter button-for-submenu" type="button" aria-expanded="false" aria-label="<?php esc_attr_e('Abrir submenú para precio', 'avante'); ?>">
                    <?= avante_get_icon('price'); ?>

...
<article id="post-<?php the_ID(); ?>" <?php post_class('glass-post'); ?> data-id="<?= get_the_ID(); ?>">
    <div class="post_body glass-border-bright">
        ...
        <div class="post__header">
            ...
            echo '<a href="' . esc_url(get_post_format_link('video')) . '" class="format-post-tag" aria-label="' . esc_attr__('Ver todas las noticias en formato video', 'avante') . '">' . avante_get_icon('video') . esc_html(__('Video', 'avante')) . '</a>';
            ?>

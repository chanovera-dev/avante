...
<article id="post-<?php the_ID(); ?>" <?php post_class('glass-post'); ?> data-id="<?= get_the_ID(); ?>">
    <div class="post_body glass-border-bright">
        ...
        <div class="post__header">
            ...
            echo '<a href="' . esc_url(get_post_format_link('image')) . '" class="format-post-tag" aria-label="' . esc_attr__('Ver todas las noticias en formato imagen', 'avante') . '">' . avante_get_icon('image') . esc_html(__('Imagen', 'avante')) . '</a>';
            ?>

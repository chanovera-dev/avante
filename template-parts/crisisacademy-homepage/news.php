...
<section id="news" class="block posts--body">
    <div class="content">
        ...
        <header class="section-header">
            ...
            <p class="description-section">Mantente informado con los últimos eventos críticos, análisis y desarrollos estratégicos que moldean el panorama internacional.</p>
        </header>
